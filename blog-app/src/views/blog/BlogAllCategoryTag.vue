    ...
    <el-container class="me-allct-container">
      <el-main>
        <el-tabs v-model="activeName">
          <el-tab-pane label="post category" name="category">
    ...
    methods: {
      ...
      getCategorys() {
        ...
        getAllCategorysDetail().then(data => {
          ...
          if (error !== 'error') {
            that.$message({type: 'error', message: 'A cate fail load', showClose: true})
          }
        })
      },
      getTags() {
        ...
        getAllTagsDetail().then(data => {
          ...
          if (error !== 'error') {
            that.$message({type: 'error', message: 'A tag fail load', showClose: true})
          }
        })
      }
    },
