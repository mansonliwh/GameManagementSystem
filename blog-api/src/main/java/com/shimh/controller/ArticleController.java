...
public class ArticleController {
    ...
    @LogAnnotation(module = "article", operation = "get all arti")
    ...
    @LogAnnotation(module = "article", operation = "get hot arti")
    ...
    @GetMapping("/new")
    @FastJsonView(include = {@FastJsonFilter(clazz = Article.class, props = {"id", "title"})})
    @LogAnnotation(module = "article", operation = "get net arti")
    ...
    @LogAnnotation(module = "article", operation = "get arti byid")
    ...
    @LogAnnotation(module = "article", operation = "add read amount")
    ...
    @FastJsonView(
            exclude = {
                    ...
                    @FastJsonFilter(clazz = Tag.class, props = {"id", "avatar"})},
            include = {@FastJsonFilter(clazz = User.class, props = {"nickname"})})
    @LogAnnotation(module = "article", operation = "get tag by id")
    ...
    @FastJsonView(
            exclude = {
                    ...
                    @FastJsonFilter(clazz = Tag.class, props = {"id", "avatar"})},
            include = {@FastJsonFilter(clazz = User.class, props = {"nickname"})})
    @LogAnnotation(module = "article", operation = "get cate by id")
    ...
    @LogAnnotation(module = "article", operation = "send article")
    ...
    @LogAnnotation(module = "article", operation = "modify arti")
    ...
    @RequiresRoles(Base.ROLE_ADMIN)
    @LogAnnotation(module = "article", operation = "delete arti")
    ...
    @LogAnnotation(module = "article", operation = "get arti time")
