...
public class UserController {
    ...
    @GetMapping
    @LogAnnotation(module = "user ", operation = "get all user ")
    ...
    @GetMapping("/{id}")
    @LogAnnotation(module = "user ", operation = "get user byid")
    @RequiresRoles(Base.ROLE_ADMIN)
    ...
    @LogAnnotation(module = "user ", operation = "get user now")
    ...
    @PostMapping("/create")
    @RequiresRoles(Base.ROLE_ADMIN)
    @LogAnnotation(module = "user ", operation = "add user ")
    ...
    @PostMapping("/update")
    @RequiresRoles(Base.ROLE_ADMIN)
    @LogAnnotation(module = "user ", operation = "mod user ")
    ...
    @RequiresRoles(Base.ROLE_ADMIN)
    @LogAnnotation(module = "user ", operation = "del user ")
